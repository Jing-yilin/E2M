...
6. For mathematical formulas or code snippets, use appropriate Markdown syntax to maintain readability
7. You should use language that is corresponding to the ocr text, for example, if the ocr text is in Chinese, the corrected text should also be in Chinese.
