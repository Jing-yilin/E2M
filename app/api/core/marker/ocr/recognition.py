...
from api.core.marker.models import setup_recognition_model
from api.core.marker.ocr.heuristics import (
    should_ocr_page,
    no_text_found,
    detect_bad_ocr,
)
from api.core.marker.ocr.lang import langs_to_ids
from api.core.marker.pdf.images import render_image
from api.core.marker.schema.page import Page
from api.core.marker.schema.block import Block, Line, Span
...
def run_ocr(
    doc, pages: List[Page], langs: List[str], rec_model, batch_multiplier=1
) -> (List[Page], Dict):
    ocr_pages = 0
    ocr_success = 0
    ocr_failed = 0
