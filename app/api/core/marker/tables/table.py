from api.core.marker.schema.bbox import merge_boxes, box_intersection_pct, rescale_bbox
from api.core.marker.schema.block import Line, Span, Block
from api.core.marker.schema.page import Page
from tabulate import tabulate
from typing import List

from api.core.marker.settings import settings
from api.core.marker.tables.cells import assign_cells_to_columns
from api.core.marker.tables.utils import (
    sort_table_blocks,
    replace_dots,
    replace_newlines,
)
